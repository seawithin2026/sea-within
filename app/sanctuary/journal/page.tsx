    ...
    <div className="relative h-screen w-screen overflow-hidden bg-black">
      ...
      {stage === 'write' && (
        <WriteStage>
          ...
          <div className="journal-fixed-wrapper">
            <div className="journal-fixed-canvas">
              ...
              <div className="relative w-full h-full flex items-center justify-center">
                ...
                {/* CALENDAR */}
                {showCalendar && (
                  <div className="calendar-panel bg-[#ccb072] shadow-xl rounded-xl p-4 w-72 max-h-[70%] overflow-auto border border-[#d8c9a3]">
                ...
                {showDeleteConfirm && (
                  <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
                    <div className="delete-modal bg-[#fdf7e6] border border-[#d8c9a3] rounded-xl p-6 shadow-xl w-80 text-center">

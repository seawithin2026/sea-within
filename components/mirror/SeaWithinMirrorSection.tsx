    ...
    <section className="mt-14 px-6 md:px-10 lg:px-16 max-w-6xl mx-auto">
      <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,1fr)] gap-12 items-center">
        ...
        <div className="relative flex items-center justify-center">
          ...
          {/* Mirror + golden lotus/mandala frame */}
          <div className="relative w-full max-w-sm aspect-[3/5] rounded-[2.5rem] bg-gradient-to-b from-slate-900/90 via-slate-950 to-black border border-[rgba(255,255,255,0.16)] shadow-[0_0_70px_rgba(0,0,0,0.95)] overflow-hidden backdrop-blur-2xl">
            {/* Golden mandala / lotus frame placeholder */}
        ...
        <div className="space-y-7">
          <div className="space-y-3">
            ...
            <p className="text-sm md:text-[0.95rem] leading-relaxed text-white/65">
              ...
              your growth is not automatic. It responds to your devotion, your
              softness, your honesty.
            </p>
          ...
          <div className="space-y-4 rounded-2xl border border-white/10 bg-white/3 px-5 py-4 backdrop-blur-xl">
            ...
            <p className="text-sm text-white/70">
              Rub your hands together gently, like you&apos;re warming a tiny,
              luminous seed between your palms. When you feel the warmth build,
              imagine that energy flowing into the seed you&apos;re about to
              plant.
            </p>

            <p className="text-sm text-white/65">
              When you&apos;re ready, place that imagined seed into the soil of
              your day—and let this mirror hold it for you.
            </p>

            <button
              type="button"
              onClick={onPlantSeed}
              className="mt-2 inline-flex items-center justify-center rounded-full border border-amber-300/70 bg-gradient-to-r from-amber-300/20 via-emerald-300/15 to-sky-300/20 px-5 py-2.5 text-[11px] tracking-[0.22em] uppercase text-amber-100 shadow-[0_0_25px_rgba(250,204,21,0.35)] hover:from-amber-300/30 hover:to-sky-300/30 transition-colors"
            >

      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center gap-8">
            <Link
              href="/sanctuary"
              className="font-body text-[13px] tracking-[2px] uppercase text-white/50 hover:text-golden-400 transition-colors"
            >
              Sanctuary
            </Link>

            <Link
              href="/sanctuary/journal"
              className="font-body text-[13px] tracking-[2px] uppercase text-white/50 hover:text-golden-400 transition-colors"
            >
              Journal
            </Link>
        ...
        <div className="md:hidden bg-sanctuary-dark/95 backdrop-blur-xl border-t border-white/5">
          <div className="px-6 py-8 flex flex-col gap-6">
            <Link
              ...
              className="font-body text-[13px] tracking-[2px] uppercase text-white/60 hover:text-golden-400"
            >
              Sanctuary
            </Link>
